    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_show_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu popup = new PopupMenu(MenuActivity.this,btn_show_menu);  //由btn_show_menu触发popubmenu显示
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()){
                            case R.id.lpig:
                                Toast.makeText(MenuActivity.this,"你点了小猪~", Toast.LENGTH_SHORT).show();
                                break;
                            case R.id.bpig:
                                Toast.makeText(MenuActivity.this,"你点了大猪~", Toast.LENGTH_SHORT).show();
                                break;
                        }
                        return true;
                    }
...
//        return true;
        ...
        switch (item.getItemId()) {
            case R.id.one:
                Toast.makeText(MenuActivity.this,"你点击了子菜单一", Toast.LENGTH_SHORT).show();
                break;
            case R.id.two:
                item.setCheckable(true);
                Toast.makeText(MenuActivity.this,"你点击了子菜单二", Toast.LENGTH_SHORT).show();
                break;
            case R.id.three:
                Toast.makeText(MenuActivity.this,"你点击了子菜单三", Toast.LENGTH_SHORT).show();
                item.setCheckable(true);
                break;
        }
        return true;
